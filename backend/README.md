...
## Project Structure
    ...
    ├── tst_lkdhs_api_deploymen_2  # Django project configurations
...
1. Clone this repo and `cd tst_lkdhs_api_deploymen_2`
...
2. Clone this repo and `cd tst_lkdhs_api_deploymen_2`
